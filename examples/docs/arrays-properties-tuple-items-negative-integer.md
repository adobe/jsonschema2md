# Negative Integer Schema

```txt
https://example.com/schemas/arrays#/properties/tuple/items/1
```
...
`integer` ([Negative Integer](arrays-properties-tuple-items-negative-integer.md))
