 ...
 *
 * @param {String} schemaFile path to schema definition file in Turtle/N3 syntax
...
Schema.load = function (schemaFile, cb) {
  ...
  function parseN3(fileContent, callback) {
  ...
  async.waterfall([ readFile, parseN3, parseRDF ], cb);
};
